...
1. **(RSA, _R<sub>s</sub>_) scatter plots**  
   ...
   - EXTRA: (RSA, _R<sub>s</sub>_) scatter plots can be generated against that of a GW, from a csv file containing (RSA, _R<sub>s</sub>_) data (no trajectory needed) (see examples).  
